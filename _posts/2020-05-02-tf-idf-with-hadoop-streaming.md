...
the [Wikipedia article](https://en.wikipedia.org/wiki/Tf–idf). It is widely used in data science tasks, especially
...
on [the official website](https://hadoop.apache.org/docs/r1.2.1/streaming.html)
