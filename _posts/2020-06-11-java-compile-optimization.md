...
To confirm my guess I used the tool [__JitWatcher__](https://github.com/AdoptOpenJDK/jitwatch) 
...
There are to ways to get the library. First of them is to build it on your own and the second one is to download already compiled [artifact](https://github.com/a10y/hsdis-macos).

After spending some time on analysing, I found out that _JIT_ makes some strange speculations. 
It is about [vector instructions](https://www.felixcloutier.com/x86/MOVD:MOVQ.html). In case with odd length of byte array
