...
[Venn Diagram](https://en.wikipedia.org/wiki/Venn_diagram) illustrates result very well.  
...
It is called [Cartesian product](https://en.wikipedia.org/wiki/Cartesian_product). The count of the result equals a product of
count of rows of both tables.
```sql
