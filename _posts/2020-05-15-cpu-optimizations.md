...
(for this purpose [JMH benchmark](https://openjdk.java.net/projects/code-tools/jmh/) is used). Let's take an array that
...
with so-called [Instruction pipelining](https://en.wikipedia.org/wiki/Instruction_pipelining). Thus, an instruction goes
...
apply [vectorization techniques](https://software.intel.com/content/www/us/en/develop/articles/vectorization-a-key-tool-to-improve-performance-on-modern-CPUs.html)
...
[<img src="/assets/img/github-icon.svg" width="100" height="100">](https://github.com/izebit/CPU-optimizations)