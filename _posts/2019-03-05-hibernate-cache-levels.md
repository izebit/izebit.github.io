...
layout: post
category: hibernate
title: cache in hibernate
---

Recently, I faced a task related to caching queries in [Hibernate framework](https://hibernate.org/). 
...
I use [ehcache](http://www.ehcache.org/) but you can use whatever you want. It is worth to mention, 
