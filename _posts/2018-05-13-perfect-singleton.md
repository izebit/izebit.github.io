...
[java memory model](https://www.logicbig.com/tutorials/core-java-tutorial/java-multi-threading/happens-before.html)
...
This code is __thead safe__ because the field `INSTANSE` is final and java memory model guarantees us that all final fields 
